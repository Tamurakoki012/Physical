   ...
   $(function() {
    ...
    @csrf
        <div class="from">
            ...
            <div class="user_name">
                <label>Name</label>
                <input class="name" type="text" name="name" value="<?php if (!empty($_SESSION["name"])) {echo htmlspecialchars($_SESSION["name"]);} ?>"><br></input>
                @if ($errors->has('name'))
            ...
            <div class="mail">
                <label>Email</label>
                <input class="email" type="text" name="email" value="<?php if (!empty($_SESSION["email"])) {echo htmlspecialchars($_SESSION["email"]);} ?>"><br></input>
                @if ($errors->has('email'))
            ...
            <div class="pas">
                ...
                <input class="password" type="text" name="password" value="<?php if (!empty($_SESSION["password"])) {echo htmlspecialchars($_SESSION["password"]);} ?>"></input><br>
                ...
                <div class="">
                    <input class="button14" type="submit" name="confirm" value="登録">
                </div>

                <div class="button4">
                    <a href="login" class="">戻る</a>
                </div>
        </div>
    </form>
</body>